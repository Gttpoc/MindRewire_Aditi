...
<link rel="stylesheet" href="{{ version_url('assets/css/trauma-rewiring/trauma-rewiring.css') }}">
@stop
        ...
        <div class="custom_container">
            <div class="textbox" data-aos="fade-up" data-aos-duration="1500">
                <h2 class="c_heading white">
                    You’re Not Overreacting. <br>
                    <span class="lightpink"> Your Body Is Just Remembering.</span>
                </h2>
                <strong class="sub_heading white">
                    Rewire Trauma Responses At The Nervous System Level Using Science- Backed Tools That Create
                    Safety From The Inside Out.
                </strong>
                <p>
                    Trauma Isn’t Just A Memory. It’s A Loop Your Brain And Body Get Stuck In. At Mind Rewire, We
                    Help You Release Those
                    Loops—Not Just Through Talk, But Through Rewiring How Your Nervous System Feels, Reacts, And
                    Recovers.
                </p>
                <div class="btnrow">
            ...
            <div class="imgbox" data-aos="fade-up" data-aos-duration="1500">
                <img src="{{ url('assets/images/trauma-rewiring/img_top_banner.png')}}" alt="image" />
            </div>
        </div>
    </div>
        ...
        <div class="common_fullrow">
            <div class="custom_container pb-0">
                <div class="common_textbox textbox" data-aos="fade-up" data-aos-duration="1500">
                    <h2 class="c_heading">
                        Techniques That Speak to the Body,
                        <span class="blue">Not Just the Mind</span>
                    </h2>
                    <div class="animate_border"></div>
                    <p>
                        <strong>Our Trauma-Informed Toolkit :</strong>
                    </p>
                    <div class="accordion_wrap">
                        <div class="accordion_new">
                            ...
                            <div class="textbox">
                                <h3>EMDR-Inspired Protocols</h3>
                                <div class="slidetext">
                                    <p>
                                        Guided recall and desensitization to reduce the charge of traumatic memories
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <g id="Page-1" transform="translate(-0.054 0.015)">
                                        <g id="_036---Brain-Wired" data-name="036---Brain-Wired"
                                            ...
                                            <path id="Shape"
                                                ...
                                                transform="translate(-0.054 -0.985)" fill="#1c3495" />
                                            <path id="Shape-2" data-name="Shape"
                                                ...
                                                transform="translate(-6.682 -3.631)" fill="#1c3495" />
                                        </g>
                                    </g>
                                </svg>
                            </div>
                            <div class="textbox">
                                <h3>Vagus Nerve Activation</h3>
                                <div class="slidetext">
                                    <p>
                                        Exercises that regulate your body’s safety signals and stress cycles
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion_new">
                                            ...
                                            <g id="Group_50617" data-name="Group 50617">
                                                <g id="Group_50616-2" data-name="Group 50616">
                                                    ...
                                                    <path id="Path_132435" data-name="Path 132435"
                                                        ...
                                                        transform="translate(0 -75.707)" fill="#1c3495" />
                            ...
                            <div class="textbox">
                                <h3>Somatic Therapy & Breathwork</h3>
                                <div class="slidetext">
                                    <p>
                                        Body-based tools to release stored tension, freeze, or fight/flight
                                        responses
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="accordion_new">
                            ...
                            <div class="textbox">
                                <h3>Mindful Exposure + Reframing</h3>
                                <div class="slidetext">
                                    <p>
                                        Gradual, safe revisiting of core triggers with expert guidance
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion_new">
                            ...
                            <div class="textbox">
                                <h3>Narrative Rebuilding</h3>
                                <div class="slidetext">
                                    <p>
                                        Shifting from survival story to personal power and clarity
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <p>
                        These Approaches Are Trauma-Sensitive, Consent-Based, And Paced According To Your
                        Readiness—Not A Schedule.
                    </p>
                </div>
                <div class="imgbox" data-aos="fade-up" data-aos-duration="1500">
                    <div class="withpatch">
                        <img src="{{ url('assets/images/trauma-rewiring/img_techniques.png')}}" alt="image" />
    ...
    <div class="section2" id="section2">
        <div class="common_fullrow">
            <div class="custom_container align-items-start reverse">
                <div class="common_textbox textbox" data-aos="fade-up" data-aos-duration="1500">
                    <h2 class="c_heading">
                        If You’ve Felt “Stuck” for Years, <br>
                        <span class="blue"> This Might Be Why</span>
                    </h2>
                    <div class="animate_border"></div>
                    <p><strong>You May Benefit From Trauma Rewiring If You :</strong></p>
                    <ul class="with_bullet pt-0">
                        <li>Have survived abuse, neglect, loss, or emotional manipulation</li>
                        <li>Feel “numb” or overly reactive in relationships</li>
                        <li>Experience panic, hypervigilance, or emotional flooding</li>
                        <li>Carry shame, guilt, or flashbacks from earlier life</li>
                        <li>Stay in toxic cycles because the unfamiliar feels unsafe</li>
                        <li>Struggle with burnout that never fully resolves</li>
                    </ul>
                    <p><strong>We Work With :</strong></p>
                    <ul class="with_bullet pt-0">
                        <li>Adults, professionals, trauma survivors</li>
                        <li>High-achievers masking emotional exhaustion</li>
                        <li>People living with Complex PTSD (C-PTSD), childhood trauma, or repetitive relationship
                            wounds</li>
                    </ul>
                </div>
                <div class="imgbox" data-aos="fade-up" data-aos-duration="1500">
                    <div class="withpatch">
                        <img src="{{ url('assets/images/trauma-rewiring/img_stuck.png')}}" alt="image" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="custom_container">
            ...
            <div class="top_textbox" data-aos="fade-up" data-aos-duration="1500">
                <h2 class="c_heading center">
                    ...
                    <span class="blue">But It Can Be Mapped.</span>
                </h2>
            ...
            <div class="boxwrap">
                <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                    <a>
                        <div class="imgbox">
                            <img src="{{ url('assets/images/trauma-rewiring/img_expert1.png')}}" alt="image" />
                        </div>
                        <div class="textbox">
                            <h3>Session 1–2</h3>
                            <p>Emotional safety building, body awareness, trigger mapping</p>
                        </div>
                    </a>
                </div>
                <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                    <a>
                        <div class="imgbox">
                            <img src="{{ url('assets/images/trauma-rewiring/img_expert2.png')}}" alt="image" />
                        </div>
                        <div class="textbox">
                            <h3>Session 3–6:</h3>
                            <p>Trauma loop identification, nervous system exercises, guided reframing</p>
                        </div>
                    </a>
                </div>
                <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                    <a>
                        <div class="imgbox">
                            <img src="{{ url('assets/images/trauma-rewiring/img_expert3.png')}}" alt="image" />
                        </div>
                        <div class="textbox">
                            <h3>Session 7–10:</h3>
                            <p>Identity rebuilding, emotion regulation mastery, boundary work</p>
                        </div>
                    </a>
                </div>
                <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                    <a>
                        <div class="imgbox">
                            <img src="{{ url('assets/images/trauma-rewiring/img_expert4.png')}}" alt="image" />
                        </div>
                        <div class="textbox">
                            <h3>Optional Add-Ons</h3>
                            <p>Journaling prompts, in-between session support, lifestyle rewiring</p>
                        </div>
                    </a>
                </div>
    ...
    <div class="testimonials" id="testimonials">
        <div class="custom_container">
            <div class="leftcol" data-aos="fade-up" data-aos-duration="1500">
                <div class="centerdiv">
                    <h2 class="c_heading white">
                        From Trauma Loops to <span class="lightpink">Emotional Liberation</span>
                    </h2>
                    ...
                    <div class="owl-carousel testimonials_carousel">
                        <div class="item">
                            <div class="contentbox">
                                ...
                                <div class="textbox">
                                    <h3>Client A – 38, Professional:</h3>
                                    <p>
                                        Years of burnout and conflict in every relationship. Turns out, I was
                                        reacting from wounds I didn’t know I had. With
                                        vagus nerve work and somatic therapy, I stopped exploding—and started
                        ...
                        <div class="item">
                            <div class="contentbox">
                                ...
                                <div class="textbox">
                                    <h3>Client B – 26, Survivor of Childhood Abuse:</h3>
                                    <p>
                                        I thought therapy was just talking. Here, I learned how to feel safe in my
                                        own body. It’s slow work, but it’s real work.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="contentbox">
                                ...
                                <div class="textbox">
                                    <h3>Client C – 33, High-Performer:</h3>
                                    <p>
                                        I kept overcommitting, pleasing everyone, burning out. Trauma rewiring
                                        helped me connect the dots and set boundaries
                                        without guilt.
                                    </p>
                                </div>
                            </div>
    ...
    <div class="last_bluebox" id="last_bluebox">
        <div class="custom_container">
            <div class="common_textbox textbox full" data-aos="fade-up" data-aos-duration="1500">
                <h2 class="c_heading white center">Your Past May Be Heavy <br>
                    <span class="lightpink">But Your Healing Can Start Lightly</span>
                </h2>
                <p>
                    No Pressure. No Pushing. Just Presence, Science, And Space To Reclaim What’s Yours.
                </p>
