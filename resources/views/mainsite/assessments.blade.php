...
<link rel="stylesheet" href="{{ version_url('assets/css/assessments/assessments.css') }}">
@stop
...
<div class="page_wrap">
        ...
        <div class="custom_container">
            <div class="textbox" data-aos="fade-up" data-aos-duration="1500">
                <h2 class="c_heading white">
                    Insight That <br>
                    <span class="lightpink"> Leads to Action.</span>
                </h2>
                <strong class="sub_heading white">
                    Not Sure What’s Behind A Child’s Behavior, Your Stress Patterns, Or A Career Mismatch? Start
                    With Science-Backed
                    Answers.
                </strong>
                <p>
                    Our Assessments Don’t Just Give You Scores—They Give You Insight. Designed To Reveal How Your
                    Mind Works, Where Your
                    Strengths Lie, And What Emotional Patterns Need Attention. Delivered With Guidance, Not
                    Guesswork.
                </p>
                <div class="btnrow">
            ...
            <div class="imgbox" data-aos="fade-up" data-aos-duration="1500">
                <img src="{{ url('assets/images/assessments/img_top_banner.png')}}" alt="image" />
            </div>
        </div>
    </div>
            ...
            <div class="custom_container align-items-start mw_1250">
                <div class="common_textbox textbox" data-aos="fade-up" data-aos-duration="1500">
                    <h2 class="c_heading">
                        ...
                        <span class="blue"> in Just One Test.</span>
                    </h2>
                    <div class="animate_border"></div>
                    <p>
                        <strong>Our Assessment Categories :</strong>
                    </p>
                    <div class="accordion_wrap">
                        <div class="accordion_new">
                            ...
                            <div class="textbox">
                                ...
                                <div class="slidetext">
                                    <p>Measures cognitive strengths: logical, spatial, numerical, verbal reasoning
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion_new">
                            ...
                            <div class="textbox">
                                <h3>Interest Profiling (RIASEC)</h3>
                                <div class="slidetext">
                                    <p>Reveals alignment with different career paths and passion areas</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion_new">
                            ...
                            <div class="textbox">
                                <h3>EQ Profiling</h3>
                                <div class="slidetext">
                                    <p>Tracks self-awareness, emotion regulation, empathy, and interpersonal style
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="icon">
                                <svg id="Group_50416" data-name="Group 50416" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path id="Path_132394" data-name="Path 132394"
                                        ...
                                        transform="translate(-143.244 -143.244)" fill="#1c3495" />
                                    <path id="Path_132395" data-name="Path 132395"
                                        ...
                                        transform="translate(-40.928 -40.928)" fill="#1c3495" />
                                    <path id="Path_132396" data-name="Path 132396"
                                        ...
                                        transform="translate(-230.215)" fill="#1c3495" />
                                    <path id="Path_132397" data-name="Path 132397"
                                        ...
                                        transform="translate(-230.215 -388.806)" fill="#1c3495" />
                                    <path id="Path_132398" data-name="Path 132398"
                                        d="M3.7,241.3H.652a.652.652,0,0,1,0-1.3H3.7a.652.652,0,0,1,0,1.3Zm0,0"
                                        transform="translate(0 -230.215)" fill="#1c3495" />
                                    <path id="Path_132399" data-name="Path 132399"
                                        d="M409.029,241.3h-3.044a.652.652,0,0,1,0-1.3h3.044a.652.652,0,0,1,0,1.3Zm0,0"
                                        transform="translate(-388.806 -230.215)" fill="#1c3495" />
                                </svg>
                            </div>
                            <div class="textbox">
                                <h3>Focus & Attention Assessments</h3>
                                <div class="slidetext">
                                    <p>Particularly for students showing signs of distraction or restlessness</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion_new">
                            ...
                            <div class="textbox">
                                ...
                                <div class="slidetext">
                                    <p>
                                        Maps emotional responses, reactivity, leadership potential, and parenting
                                        styles
                                    </p>
                                </div>
                            </div>
                    ...
                    <p>
                        <strong>Note :</strong>
                        All Assessments Are Validated Tools, Customized Per Age Group, And Interpreted By Certified
                        Professionals.
                    </p>
                </div>
                <div class="imgbox" data-aos="fade-up" data-aos-duration="1500">
                    <div class="withpatch">
                        <img src="{{ url('assets/images/assessments/img_clarity.png')}}" alt="image" />
    ...
    <div class="fullwrap1">
        <div class="section2" id="section2">
            <div class="custom_container">
                <div class="top_textbox" data-aos="fade-up" data-aos-duration="1500">
                    <h2 class="c_heading center">Easy, Flexible,
                        <span class="blue"> and Always Guided</span>
                    </h2>
                ...
                <div class="commonbox_wrap">
                    <a class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                        <div class="roundicon">
                            <img src="{{ url('assets/images/assessments/icon_delivery_options_1.png')}}" alt="image" />
                        </div>
                        <div class="topbox">
                            <h3>Online <span class="blue">Format</span></h3>
                            <ul>
                                <li>Secure login + time-controlled interface</li>
                                <li>Live walkthrough of results</li>
                                <li>Ideal for remote clients and schools</li>
                            </ul>
                        </div>
                    </a>
                    <a class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                        <div class="roundicon">
                            <img src="{{ url('assets/images/assessments/icon_delivery_options_2.png')}}" alt="image" />
                        </div>
                        <div class="topbox">
                            <h3>Offline <span class="blue">(on request)</span></h3>
                            <ul>
                                <li>For group assessments, schools, and in-person workshops</li>
                                <li>Paper-pencil or tablet-based with facilitator supervision</li>
                            </ul>
                        </div>
                    </a>
                    <a class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                        <div class="roundicon">
                            <img src="{{ url('assets/images/assessments/icon_delivery_options_3.png')}}" alt="image" />
                        </div>
                        <div class="topbox">
                            <h3>Post-Test <span class="blue">Flow:</span></h3>
                            <ul>
                                <li>Expert Interpretation</li>
                                <li>Personalized action report (PDF)</li>
                                <li>Optional session for strategy and next steps</li>
                            </ul>
                        </div>
                    </a>
                </div>
        ...
        <div class="section3" id="section3">
            <div class="custom_container">
                <div class="common_textbox textbox full" data-aos="fade-up" data-aos-duration="1500">
                    <h2 class="c_heading">Designed for All Ages <br>
                        <span class="blue"> & Life Stages</span>
                    </h2>
                    <div class="animate_border"></div>
                    <p>
                        <strong>We Offer Custom Assessment Paths For :</strong>
                    </p>
                </div>
                <div class="boxwrap">
                    <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                        <a>
                            <div class="imgbox">
                                <img src="{{ url('assets/images/assessments/img_assessment1.png')}}" alt="image" />
                            </div>
                            <div class="textbox">
                                <h3>Students (Ages 10–24)</h3>
                                <ul>
                                    <li>For academic decisions, focus issues, or career direction</li>
                                    <li>Combined with parent guidance sessions</li>
                                </ul>
                            </div>
                        </a>
                    </div>
                    <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                        <a>
                            <div class="imgbox">
                                <img src="{{ url('assets/images/assessments/img_assessment2.png')}}" alt="image" />
                            </div>
                            <div class="textbox">
                                <h3>Parents</h3>
                                <ul>
                                    <li>
                                        To understand parenting style, child compatibility, or emotional blind spots
                                    </li>
                                    <li>Great for parent-child alignment</li>
                                </ul>
                            </div>
                        </a>
                    </div>
                    <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                        <a>
                            <div class="imgbox">
                                <img src="{{ url('assets/images/assessments/img_assessment3.png')}}" alt="image" />
                            </div>
                            <div class="textbox">
                                <h3>Working Professionals</h3>
                                <ul>
                                    <li>
                                        For behavioral insights, leadership EQ, and burnout predictors
                                    </li>
                                    <li>
                                        Can be tied to therapy or performance coaching
                                    </li>
                                </ul>
                            </div>
                        </a>
                    ...
                    <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                        <a>
                            <div class="imgbox">
                                <img src="{{ url('assets/images/assessments/img_assessment4.png')}}" alt="image" />
                            </div>
                            <div class="textbox">
                                <h3>Schools & Institutions:</h3>
                                <ul>
                                    <li>As part of climate audits, remedial programs, or emotional literacy rollouts
                                    </li>
                                </ul>
                            </div>
                        </a>
        ...
        <div class="rgtpatch">
            <img src="{{ url('assets/images/common_circle_right.png')}}" alt="image" />
        </div>
    </div>
    ...
    <div class="section4" id="section4">
        <div class="common_fullrow">
            <div class="custom_container">
                <div class="common_textbox textbox" data-aos="fade-up" data-aos-duration="1500">
                    <h2 class="c_heading">Here’s What <br>
                        <span class="blue"> You’ll Walk Away With</span>
                    </h2>
                    <div class="animate_border"></div>
                    <p><strong>Includes :</strong></p>
                    <ul class="with_bullet pt-0">
                        <li>Top-scoring strengths</li>
                        <li>Improvement zones</li>
                        <li>Behavioral & cognitive summaries</li>
                        <li>Visual career path or personality maps</li>
                        <li>Therapist’s or expert’s notes and recommendations</li>
                        <li>Optional next-step plan (skills, habits, sessions)</li>
                    </ul>
                    <div class="animate_border"></div>
                    <ul class="with_bullet">
                        <li>
                            <strong>Format:</strong><br> PDF, 8–15 pages
                        </li>
                        <li>
                            <strong>Language:</strong><br> Clear, visual, parent- and teen-friendly
                        </li>
                        <li>
                            <strong>Access:</strong><br> Delivered digitally with option for verbal debrief
                        </li>
                    </ul>
                    <div class="btnrow" data-aos="fade-up" data-aos-duration="1500">
                        <a href="{{url('enquiry-form')}}" class="cta_btn animation_white_line animate_arrow">
                ...
                <div class="imgbox" data-aos="fade-up" data-aos-duration="1500">
                    <img src="{{ url('assets/images/assessments/img_walk_away.png')}}" alt="image" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="last_bluebox" id="last_bluebox">
        <div class="custom_container">
            <div class="common_textbox textbox full" data-aos="fade-up" data-aos-duration="1500">
                <h2 class="c_heading white center">You Can’t Manage <br>
                    <span class="lightpink">What You Don’t Understand</span>
                </h2>
                <p>
                    Whether It’s A Child’s Confusion, A Professional’s Burnout, Or A Parent’s <br> Doubt—Our
                    Assessments Bring Emotional Clarity
