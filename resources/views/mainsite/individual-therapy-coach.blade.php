...
<title>Individual Therapy & Emotional Coaching – Mind Rewire</title>
<meta name="description"
    content="Personalized therapy for anxiety, trauma, stress, burnout, and emotional overwhelm. Explore CBT, REBT, NLP, and trauma-informed tools with a therapist who listens, guides, and helps you rewire your emotional patterns.">
<meta name="keywords"
    content="therapy for stress, online counselling India, CBT therapist near me, NLP life coach, REBT for anxiety, trauma recovery sessions, burnout therapy, individual therapy online, somatic trauma healing, therapy for emotional clarity">

<meta name="twitter:card" content="summary" />
<meta name="twitter:site" content="@skybridge" />
<meta name="twitter:creator" content="@skybridge" />
<meta name="twitter:title" content="Individual Therapy & Emotional Coaching – Mind Rewire">
...
<meta property="og:title" content="Individual Therapy & Emotional Coaching – Mind Rewire" />
...
<link rel="stylesheet" href="{{ version_url('assets/css/individual-therapy/individual-therapy.css') }}">
@stop
...
<div class="page_wrap">
        ...
        <div class="custom_container">
            <div class="textbox" data-aos="fade-up" data-aos-duration="1500">
                <h2 class="c_heading white">
                    Because Feeling Better Starts <br>
                    <span class="lightpink"> With Feeling Understood</span>
                </h2>
                <strong class="sub_heading white">
                    Our Individual Therapy Blends Science-Backed Tools And Deep Listening To Help You Regain
                    Emotional Balance,
                    Self-Awareness, And Control.
                </strong>
                <p>
                    You’re Not Broken. You’re Carrying Patterns That Can Be Rewired. Whether You’re Overwhelmed,
                    Anxious, Burned Out, Or
                    Simply Stuck—This Is Your Space To Breathe, Express, And Build Clarity Without Judgment.
                </p>
                <div class="btnrow">
            ...
            <div class="imgbox" data-aos="fade-up" data-aos-duration="1500">
                <img src="{{ url('assets/images/individual-therapy/img_top_banner.png')}}" alt="image" />
            </div>
        </div>
    </div>
        ...
        <div class="common_fullrow">
            <div class="custom_container align-items-start pb-0">
                <div class="common_textbox textbox" data-aos="fade-up" data-aos-duration="1500">
                    <h2 class="c_heading">
                        This Is for You <br>
                        <span class="blue">If You’ve Said…</span>
                    </h2>
                    <div class="animate_border"></div>
                    <ul class="with_bullet">
                        <li>“I feel anxious all the time, and I don’t know why.”</li>
                        <li>“I keep repeating patterns I want to break.”</li>
                        <li>“I don’t feel heard—by anyone, including myself.”</li>
                        <li>“I’m stuck in overthinking, guilt, or burnout.”</li>
                        <li>“I’ve tried coping, but nothing sticks.”</li>
                    </ul>
                    <p>
                        <strong>Audience We Serve:</strong>
                    </p>
                    <ul class="with_bullet pt-0">
                        <li>Adults seeking emotional clarity and healing</li>
                        <li>Working professionals navigating stress, imposter syndrome, or identity conflicts</li>
                        <li>Women managing invisible loads, relationship strain, or trauma recovery</li>
                        <li>Anyone needing a safe space to talk, feel, and grow</li>
                    </ul>
                </div>
                <div class="imgbox" data-aos="fade-up" data-aos-duration="1500">
                    <div class="withpatch">
                        <img src="{{ url('assets/images/individual-therapy/img_foryou.png')}}" alt="image" />
    ...
    <div class="common_accordion section2" id="section2">
        <div class="common_fullrow">
            <div class="custom_container pb-0 align-items-start reverse">
                <div class="common_textbox textbox" data-aos="fade-up" data-aos-duration="1500">
                    <h2 class="c_heading">
                        A Therapy Approach <br>
                        <span class="blue">as Unique as You</span>
                    </h2>
                    <div class="animate_border"></div>
                    <p>
                        <strong>Methods Blended Into Sessions :</strong>
                    </p>
                    <div class="accordion_wrap">
                        <div class="accordion_new">
                            ...
                            <div class="textbox">
                                ...
                                <div class="slidetext">
                                    <p>
                                        Restructure thoughts that trigger anxiety, guilt, and negativity.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion_new">
                            ...
                            <div class="textbox">
                                <h3>REBT (Rational Emotive Behavior Therapy)</h3>
                                <div class="slidetext">
                                    <p>
                                        Challenge the beliefs that limit your confidence and peace.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion_new">
                            ...
                            <div class="textbox">
                                <h3>NLP (Neuro-Linguistic Programming)</h3>
                                <div class="slidetext">
                                    <p>
                                        Rewire how you think, speak, and act—with new emotional responses.
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
                                    ...
                                    <g id="Group_50414" data-name="Group 50414" transform="translate(-2 -2)">
                                        <path id="Path_132290" data-name="Path 132290"
                                            ...
                                            fill="#213f6c" fill-rule="evenodd"></path>
                                        ...
                                        <path id="Path_132292" data-name="Path 132292"
                                            ...
                                            transform="translate(-23.897 -8.434)" fill="#213f6c"></path>
                                        <path id="Path_132293" data-name="Path 132293"
                                            ...
                                            transform="translate(-7.028 -23.897)" fill="#213f6c"></path>
                                    </g>
                                </svg>
                            </div>
                            <div class="textbox">
                                <h3>Somatic & Trauma-Informed Practices</h3>
                                <div class="slidetext">
                                    <p>
                                        Address nervous system dysregulation, fight/flight cycles, and body-mind
                                        blocks.
                                    </p>
                                </div>
                            </div>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                    ...
                                    <g id="Group_50136" data-name="Group 50136" transform="translate(-2.74 -2.21)">
                                        <path id="Path_132222" data-name="Path 132222"
                                            ...
                                            transform="translate(-6.561)" fill="#213f6c"></path>
                                        <path id="Path_132223" data-name="Path 132223"
                                            ...
                                            transform="translate(-6.561 -34.164)" fill="#213f6c"></path>
                                        <path id="Path_132224" data-name="Path 132224"
                                            ...
                                            transform="translate(0 -22.415)" fill="#213f6c"></path>
                                        ...
                                        <path id="Path_132228" data-name="Path 132228"
                                            ...
                                            transform="translate(-57.289 -18.593)" fill="#213f6c"></path>
                                        <path id="Path_132229" data-name="Path 132229"
                                            ...
                                            transform="translate(-63.451 -38.84)" fill="#213f6c"></path>
                                        <path id="Path_132230" data-name="Path 132230"
                                            ...
                                            transform="translate(-67.853 -59.967)" fill="#213f6c"></path>
                                    </g>
                                </svg>
                            </div>
                            <div class="textbox">
                                <h3>Narrative + Goal-Focused Coaching</h3>
                                <div class="slidetext">
                                    <p>
                                        Align actions with who you want to become—on your terms.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <p>
                        These are not “one-size-fits-all” methods. Every session is curated based on where you are
                        and where you want to go.
                    </p>
                </div>
                <div class="imgbox" data-aos="fade-up" data-aos-duration="1500">
                    <div class="withpatch">
                        <img src="{{ url('assets/images/individual-therapy/img_accordion.png')}}" alt="image" />
                    </div>
        ...
        <div class="custom_container">
            <div class="top_textbox" data-aos="fade-up" data-aos-duration="1500">
                <h2 class="c_heading center">
                    Choose What <span class="blue"> Fits You Best</span>
                </h2>
                <div class="animate_border center"></div>
                <p>Available Formats :</p>
            </div>
            <div class="boxwrap_new">
                <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                    <a>
                        <div class="imgbox">
                            <img src="{{ url('assets/images/individual-therapy/img_choose1.png')}}" alt="image" />
                        </div>
                        <div class="common_textbox textbox">
                            <h3>Online Therapy</h3>
                            <div class="animate_border"></div>
                            <ul class="with_bullet">
                                <li>Secure video sessions via Zoom/Google Meet</li>
                                <li>Flexible time slots</li>
                                <li>Ideal for working professionals and remote clients</li>
                            </ul>
                        </div>
                    </a>
                </div>
                <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                    <a>
                        <div class="imgbox">
                            <img src="{{ url('assets/images/individual-therapy/img_choose2.png')}}" alt="image" />
                        </div>
                        <div class="common_textbox textbox">
                            <h3>In-Person Sessions (Pune)</h3>
                            <div class="animate_border"></div>
                            <ul class="with_bullet">
                                <li>Select slots available on request</li>
                                <li>Safe and private space</li>
                            </ul>
                        </div>
                    </a>
                </div>
            </div>
            <div class="session_details" data-aos="fade-up" data-aos-duration="1500">
                <strong class="btext">Session Details :</strong>
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        Weekly / Bi-Weekly (Customized)
                    </li>
                    <li>
                        <strong>Packages:</strong>
                        Single Session | Bundle Of 4 | Bundle Of 6 (Discounted)
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="section4" id="section4">
        <div class="custom_container">
            <div class="top_textbox" data-aos="fade-up" data-aos-duration="1500">
                <h2 class="c_heading">
                    What Can <br> <span class="blue"> Change for You?</span>
                </h2>
                <div class="animate_border"></div>
            </div>
            <div class="boxwrap">
                <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                    <a>
                        <div class="imgbox">
                            <img src="{{ url('assets/images/individual-therapy/img_change1.png')}}" alt="image" />
                        </div>
                        <div class="textbox">
                            <p>Clients With Panic Attacks Learning Self-Regulation Within 6–8 Sessions</p>
                        </div>
                    </a>
                </div>
                <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                    <a>
                        <div class="imgbox">
                            <img src="{{ url('assets/images/individual-therapy/img_change2.png')}}" alt="image" />
                        </div>
                        <div class="textbox">
                            <p>High-Performing Professionals Rediscovering Sleep, Clarity, And Confidence</p>
                        </div>
                    </a>
                </div>
                <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                    <a>
                        <div class="imgbox">
                            <img src="{{ url('assets/images/individual-therapy/img_change3.png')}}" alt="image" />
                        </div>
                        <div class="textbox">
                            <p>Individuals Once Stuck In Guilt Cycles Now Setting Boundaries With Ease</p>
                        </div>
                    </a>
                </div>
                <div class="commonbox" data-aos="fade-up" data-aos-duration="1500">
                    <a>
                        <div class="imgbox">
                            <img src="{{ url('assets/images/individual-therapy/img_change4.png')}}" alt="image" />
                        </div>
                        <div class="textbox">
                            <p>Women Reconnecting To Their Identity Beyond Roles And Expectations</p>
                        </div>
                    </a>
                </div>
            ...
            <div class="key_results" data-aos="fade-up" data-aos-duration="1500">
                <strong class="btext">Key Results You Can Expect :</strong>
                <div class="common_textbox">
                    <ul class="with_bullet">
                        <li>Emotional clarity without shame</li>
                        <li>Stronger self-awareness and resilience</li>
                        <li>Improved relationships (with self and others)</li>
                        <li>The tools to manage—not suppress—what you feel</li>
                        <li>Motivation without burnout</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="last_bluebox" id="last_bluebox">
        <div class="custom_container">
            <div class="common_textbox textbox full" data-aos="fade-up" data-aos-duration="1500">
                <h2 class="c_heading white center">Ready to Rewire <br>
                    <span class="lightpink">What’s Holding You Back?</span>
                </h2>
                <p>
                    Your Journey Starts With A Single Session—And A Space That <br> Feels Safe, Seen, And
                    Structured.
                </p>
